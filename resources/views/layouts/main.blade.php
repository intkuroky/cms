...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>烟草CMS</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>卷烟物流信息管理系统</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('imgs/avatar.png') }}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ $authUser->name }}
                                    <small>{{ $authUser->created_at }}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
    ...
    <footer class="main-footer">
        ...
        {{--</div>--}}
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">烟草物流信息管理系统</a>.</strong> All rights reserved.
    </footer>
